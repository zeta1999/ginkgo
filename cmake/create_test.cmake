...
function(ginkgo_create_mpi_test test_name num_mpi_procs)
  ...
  if("${MPI_EXECUTABLE_SUFFIX}" MATCHES ".openmpi")
      set(OPENMPI_RUN_AS_ROOT "--allow-run-as-root")
  else()
      set(OPENMPI_RUN_AS_ROOT "")
  endif()
  target_link_libraries(${TEST_TARGET_NAME} PRIVATE ginkgo GTest::Main GTest::GTest ${ARGN})
  target_link_libraries(${TEST_TARGET_NAME} PRIVATE ${MPI_C_LIBRARIES} ${MPI_CXX_LIBRARIES})
  set(test_param ${MPIEXEC_NUMPROC_FLAG} ${num_mpi_procs} ${OPENMPI_RUN_AS_ROOT} ${CMAKE_BINARY_DIR}/${REL_BINARY_DIR}/${test_name})
